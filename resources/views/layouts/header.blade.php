                    ...
                    <div class="container">
                        ...
                        <div class="topbar-menu right-menu">
                            <ul>
                                @guest
                                    @if (Route::has('login'))
										<li class="menu-item"><a title="Login" href="{{ route('login') }}">Đăng Nhập</a></li>
                                    @endif

                                    @if (Route::has('register'))
										<li class="menu-item"><a title="Register" href="{{ route('register') }}">Đăng Ký</a>
                                    @endif
                                @else
                                    <li class="menu-item menu-item-has-children parent">
										...
										<ul class="submenu curency">
											...
											<li class="menu-item">
												<a title="Admin" href="{{ route('admins') }}" >Admin</a>
											</li>
											@endif 
											<li class="menu-item">
                    ...
                    <div class="primary-nav-section">
                        <div class="container">
                            <ul class="nav primary clone-main-menu" id="mercado_main" data-menuname="Main menu">
                                ...
                                <li class="menu-item">
                                    <a href="{{ route('shop') }}"
                                        class="link-term mercado-item-title {{ Request::routeIs('shop') ? 'active-header-menu' : '' }}">Shop</a>
                                </li>
                                <li class="menu-item">
                                    <a href="{{ route('cart') }}"
